...
public class Sancion implements Serializable {
    ...
    @OneToMany(mappedBy = "sancionCodigo")
    ...
    public Sancion(Integer codigo, String tipo, Integer valor, String descripcion) {
        this.codigo = codigo;
        this.tipo = tipo;
        this.valor = valor;
    ...
    public String toString() {
        return "co.usta.edu.wsgerencia.entity.Sancion[ codigo=" + codigo + " ]";
    }
